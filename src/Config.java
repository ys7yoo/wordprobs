...
class Config{
  ...
  boolean bParallelize = true;
  int iNumThreads;
  boolean bUseCheatFeature = false;
  boolean bLoadNGrams = true;
  int iMinEquationCount = 0;
  boolean bPrintBarsAroundConstants = false;
  boolean bPruneToTenQuestionsForTesting = false;
  boolean bPrintErrorAnalysis = false;
  boolean bPrintCorrectErrorAnalysis = false;
  ...
  boolean bPrintPerQuestionStats = false;
